...
/**
 * 通过 Java 代码来创建电子邮件，并连接邮件服务器发送邮件。
 * @author Weifeng Hao
 *
 */
public class MailSender {
	...
	public static void main (String[] args) {     
		...
		mailInfo.setPassword("hwfwdmm1314521");//您的邮箱密码        
		mailInfo.setFromAddress("alburtams@163.com");  
		      
		List<String> address = new ArrayList<String>();      
		address.add("328760741@qq.com");     
		address.add("1055296551@qq.com");  
		address.add("1476747380@qq.com");       
